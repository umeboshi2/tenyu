...
from tenyu.models.truffula import VTSpecies
from tenyu.managers.truffula import GenusManager, SpecNameManager
from tenyu.managers.truffula import VTSpeciesManager
